...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-w-full px-3">
      <div className='w-full my-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 m-3 bg-bg-base-2 text-gray-900 rounded-xl shadow-lg'>
